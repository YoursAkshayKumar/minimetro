...
<head>
    ...
    <title>E-Rickshaw Passenger (Model: M1-MS)-Mini Metro EV LLP</title>
    <meta name="description" content="Buy Mini Metro E-Rickshaw Passenger (Model: M1-MS) 
    with 4+(1 Driver) load capacity fully-featured, colors, and customization available.
     To know more call:- 7617787857.">

    <meta name="keywords" content="Buy E-rickshaw Passenger, erickshaw (Model: M1-MS), 
...
<div class="limoking-page-title-wrapper header-style-2-title-wrapper">
    ...
    <div class="limoking-page-title-container container">
        <h1 class="limoking-page-title"  style="color: black;">M1 MS</h1>
