                                ...
                                <div class="limoking-item-title-wrapper limoking-item  limoking-center-icon-divider limoking-large ">
                                    <div class="limoking-item-title-container container">
                                        <div class=limoking-item-title-head-inner>
                                            <h3 class="limoking-item-title limoking-skin-title limoking-skin-border">We serve you like a king</h3></div>
										...
										<ul class=slides>
										   <li class="limoking-item limoking-car-item limoking-modern-car">
										      <div class=car-thumbnail>
										         <img src=upload/car-11.jpg alt width=600 height=343>
										         <span class=car-overlay>&nbsp;</span>
										         <a class=car-overlay-icon href=#>
										         <span class=car-icon >
										      ...
										      <h3 class="car-title">
										         <a href=# >Hire This Car</a>
										      </h3>
										   </li>
										   <li class="limoking-item limoking-car-item limoking-modern-car">
										      <div class=car-thumbnail>
										         <img src=upload/car-21.jpg alt width=600 height=343>
										         <span class=car-overlay>&nbsp;</span>
										         <a class=car-overlay-icon href=#>
										         <span class=car-icon >
										         <i class="fa fa-link" ></i>
										   ...
										   <li class="limoking-item limoking-car-item limoking-modern-car">
										      <div class=car-thumbnail>
										         <img src=upload/car-31.jpg alt width=600 height=343>
										         <span class=car-overlay>&nbsp;</span>
										         <a class=car-overlay-icon href=#>
										         <span class=car-icon >
										         <i class="fa fa-link" ></i>
										   ...
										   <li class="limoking-item limoking-car-item limoking-modern-car">
										      <div class=car-thumbnail>
										         <img src=upload/car-41.jpg alt width=600 height=343>
										         <span class=car-overlay>&nbsp;</span>
										         <a class=car-overlay-icon href=#>
										         <span class=car-icon >
										         <i class="fa fa-link" ></i>
										   ...
										   <li class="limoking-item limoking-car-item limoking-modern-car">
										      <div class=car-thumbnail>
										         <img src=upload/car-51.jpg alt width=600 height=343>
										         <span class=car-overlay>&nbsp;</span>
										         <a class=car-overlay-icon href=#>
										         <span class=car-icon >
										         <i class="fa fa-link" ></i>
										   ...
										   <li class="limoking-item limoking-car-item limoking-modern-car">
										      <div class=car-thumbnail>
										         <img src=upload/car-61.jpg alt width=600 height=343>
										         <span class=car-overlay>&nbsp;</span>
										         <a class=car-overlay-icon href=#>
										         <span class=car-icon >
										         <i class="fa fa-link" ></i>
										   ...
										   <li class="limoking-item limoking-car-item limoking-modern-car">
										      <div class=car-thumbnail>
										         <img src=upload/car-71.jpg alt width=600 height=343>
										         <span class=car-overlay>&nbsp;</span>
										         <a class=car-overlay-icon href=#>
										         <span class=car-icon >
										         <i class="fa fa-link" ></i>
										   ...
										   <li class="limoking-item limoking-car-item limoking-modern-car">
										      <div class=car-thumbnail>
										         <img src=upload/car-81.jpg alt width=600 height=343>
										         <span class=car-overlay>&nbsp;</span>
										         <a class=car-overlay-icon href=#>
										         <span class=car-icon >
										         <i class="fa fa-link" ></i>
										   ...
										   <li class="limoking-item limoking-car-item limoking-modern-car">
										      <div class=car-thumbnail>
										         <img src=upload/car-91.jpg alt width=600 height=343>
										         <span class=car-overlay>&nbsp;</span>
										         <a class=car-overlay-icon href=#>
										         <span class=car-icon >
										         <i class="fa fa-link" ></i>
                        ...
                        <div class=container>
                            <div class="four columns">
                                <div class="limoking-item-title-wrapper limoking-item  limoking-left limoking-small ">
                                    <div class="limoking-item-title-container container">
                                        <div class=limoking-item-title-head-inner>
                                            <h3 class="limoking-item-title limoking-skin-title limoking-skin-border">Video Tour</h3></div>
                                    </div>
                                </div>
                                                    ...
                                                    <li class=testimonial-item>
                                                        <div class="testimonial-item-inner limoking-skin-box">
                                                            <div class=testimonial-item-content-wrapper>
                                                                ...
                                                                <div class=testimonial-info><span class="testimonial-author limoking-skin-link-color">John Doe<span>, </span></span><span class="testimonial-position limoking-skin-info">General Manager, Coca Co.</span></div>
                                                                <div class=clear></div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class=testimonial-item>
                                                        <div class="testimonial-item-inner limoking-skin-box">
                                                            <div class=testimonial-item-content-wrapper>
                                                                ...
                                                                <div class=testimonial-info><span class="testimonial-author limoking-skin-link-color">Sam Smith<span>, </span></span><span class="testimonial-position limoking-skin-info">CEO, The Klise</span></div>
                                                                <div class=clear></div>
                                                            </div>
                                                        </div>
                                                    </li>
