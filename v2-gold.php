...
<head>
    ...
    <title>E-Rickshaw Passenger (Model: M1-V2 GOLD)-Mini Metro EV LLP</title>
    <meta name="description" content="Buy Mini Metro E-Rickshaw Passenger (Model: V2 GOLD) with 4+(1 Driver) 
    load capacity fully-featured, colors, and customization available. To know more call:- 7617787857.">

    <meta name="keywords" content="Buy E-rickshaw Passenger (Model: V2 GOLD), erickshaw,
...
<div class="limoking-page-title-wrapper header-style-2-title-wrapper">
    ...
    <div class="limoking-page-title-container container">
        <h1 class="limoking-page-title"  style="color: black;">V2 (Gold)</h1> 
                ...
                <div class="with-sidebar-left twelve columns">
                    <div class="with-sidebar-content twelve columns">
                            ...
                            <div id=portfolio-76 class="post-76 portfolio type-portfolio status-publish has-post-thumbnail hentry portfolio_category-taxi-service portfolio_tag-party-ride portfolio_tag-taxi">
                                ...
                                <div class="limoking-portfolio-thumbnail limoking-image">
                                    <div class=flexslider data-pausetime=7000 data-slidespeed=600 data-effect=fade>
                                        <ul class=slides>
                                            <li>
                                                <a href="upload/v2ss/_RAJ8452.jpg" data-fancybox-group=limoking-gal-1 data-rel=fancybox><img src="upload/v2ss/_RAJ8452.jpg" alt width=1280 height=853></a>
                                            </li>
                                            <li>
                                                <a href="upload/v2ss/_RAJ8463.jpg" data-fancybox-group=limoking-gal-1 data-rel=fancybox><img src="upload/v2ss/_RAJ8463.jpg" alt width=750 height=330></a>
                                            </li>
                                            <li>
                                                <a href="upload/v2ss/_RAJ8470.jpg" data-fancybox-group=limoking-gal-1 data-rel=fancybox><img src="upload/v2ss/_RAJ8470.jpg" alt width=750 height=330></a>
                                            </li>
                                            <li>
                                                <a href="upload/v2ss/_RAJ8489.jpg" data-fancybox-group=limoking-gal-1 data-rel=fancybox><img src="upload/v2ss/_RAJ8489.jpg" alt width=750 height=330></a>
                                            </li>
                                            <li>
                                                <a href="upload/v2ss/_RAJ8493.jpg" data-fancybox-group=limoking-gal-1 data-rel=fancybox><img src="upload/v2ss/_RAJ8493.jpg" alt width=1280 height=853></a>
                                            </li>
                                            <li>
                                                <a href="upload/v2ss/_RAJ8496.jpg" data-fancybox-group=limoking-gal-1 data-rel=fancybox><img src="upload/v2ss/_RAJ8496.jpg" alt width=1280 height=853></a>
                                            </li>
                                            <li>
                                                <a href="upload/v2ss/_RAJ8589.jpg" data-fancybox-group=limoking-gal-1 data-rel=fancybox><img src="upload/v2ss/_RAJ8589.jpg" alt width=1280 height=853></a>
                                            </li>
                                            <li>
                                                <a href="upload/v2ss/_RAJ8590.jpg" data-fancybox-group=limoking-gal-1 data-rel=fancybox><img src="upload/v2ss/_RAJ8590.jpg" alt width=1280 height=853></a>
                                            </li>
                                            <li>
                                                <a href="upload/v2ss/_RAJ8593.jpg" data-fancybox-group=limoking-gal-1 data-rel=fancybox><img src="upload/v2ss/_RAJ8593.jpg" alt width=1280 height=853></a>
                                            </li>
                                            <li>
                                                <a href="upload/m1ss/V2_SS_BLUE.jpg" data-fancybox-group=limoking-gal-1 data-rel=fancybox><img src="upload/m1ss/V2_SS_BLUE.jpg" alt width=1280 height=853></a>
                                            </li>
                                            <li>
                                                <a href="upload/m1ss/V2_SS_LEFT_BLUE.jpg" data-fancybox-group=limoking-gal-1 data-rel=fancybox><img src="upload/m1ss/V2_SS_LEFT_BLUE.jpg" alt width=1280 height=853></a>
                                            </li>
                                            <li>
                                                <a href="upload/m1ss/V2_SS_RIGHT_BLUE.jpg" data-fancybox-group=limoking-gal-1 data-rel=fancybox><img src="upload/m1ss/V2_SS_RIGHT_BLUE.jpg" alt width=1280 height=853></a>
                                            </li>
                                ...
                                <div class=limoking-portfolio-content>
                                    <div class=limoking-portfolio-info>
                                        ...
                                        <div class=content>
                                            <div class="portfolio-info portfolio-clients"><span class="info-head limoking-title">Colors: </span><i class="fas fa-circle" style="color: red;"></i>Red
                                             &nbsp; <i class="fas fa-circle" style="color: blue;"></i>Blue &nbsp; <i class="fas fa-circle" style="color: #2e8b57;"></i>Sea Green
                                             &nbsp; <i class="fas fa-circle" style="color: #000000;"></i>Black</div>
                                            <div class="portfolio-info portfolio-skills"><span class="info-head limoking-title">Capacity: </span>4+(1 driver)</div>
                                            <div class="portfolio-info portfolio-website"><span class="info-head limoking-title"> Speed: </span>25 Kmph</div>
                                            <div class="portfolio-info portfolio-tag"><span class="info-head limoking-title">Battery: </span>Exide<span class=sep></span></div>
                                            <div class=clear></div>
                                    ...
                                    <div class=limoking-portfolio-description>
                                        ...
                                        <div class=content>
                                            <p>We offer wide range of models with different colors . Being these products featuring Eco-friendliness,
                                                Pollution-Free, Noiseless, Cost-Effective, almost zero running cost, stylish look and appeal, these
                                                are widely appreciated by the customer.</p>
                                        </div>
                                    </div>
                                    <div class=clear></div>
                                </div>
                        ...
                        <section id=content-section-2>
                            <div class="limoking-color-wrapper  gdlr-show-all no-skin" style="background-color: #fff; padding-bottom: 24px; padding-top: 30px;">
                                <div class=container>
                                        ...
                                        <div class="limoking-item limoking-about-us-item limoking-with-caption">
                                            ...
                                            <div class=about-us-content-wrapper>
                                                <div class="about-us-content limoking-skin-content">
                                                    ...
                                                    <p>E-Rickshaw is a gift to lower segment of society namely “Rickshaw-walla’s”,
                                                        which originated from china but earlier models had its own safety flaws ,We
                                                        thoroughly studied Chinese E- Rickshaw & using our automotive industry past
                                                        experience we have re-designed the e-rickshaw which can meet industry standards
                                                        & suitable for rough indian roads.</p>
                                                                ...
                                                                <td width="50%">
                                                                    <table border="1" cellspacing="0">
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <td>18</td>
                                                                                <td>Emergency Cut Off Switch</td>
                                                                                <td>Available (in Handi)</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>19</td>
                                                                                <td>Battery Discharge Meter indicator</td>
                                                                                <td>Available</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>20</td>
